          ...
          <div className="w-full md:w-1/2 overflow-x-auto">
            <div className="min-w-[300px]">
              <table className="w-full">
                <thead>
                  <tr>
                    <th className="text-left text-xs sm:text-sm font-medium text-muted-foreground">Source</th>
                    ...
                    <tr key={index} className="border-b last:border-b-0 border-gray-100">
                      <td className="py-2">
                        <div className="flex items-center gap-2">
                          ...
                          ></div>
                          <span className="text-xs sm:text-sm">{formatSourceName(item.source)}</span>
                        </div>
                      </td>
                      <td className="py-2 text-right text-xs sm:text-sm">{formatNaira(item.amount)}</td>
                      <td className="py-2 text-right text-xs sm:text-sm">{item.percentage.toFixed(1)}%</td>
                    </tr>
                  ))}
                </tbody>
              </table>
